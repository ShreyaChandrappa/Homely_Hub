...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51OyEDfFxz4jwbm5DoaIWEMxQr8iaE9sNwLtYR6VW8ctk5ZIvSvOqTyOxFCwHPQ8kh0mGwzBEdfFIiza0TbX9c33e00hK3K05eL"
  );
  ...
  return (<div className="App">
    {/*This ensures that the routing functionallity is available throughout the application*/}
